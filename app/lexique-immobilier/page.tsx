...
const articles = [
  {
    ...
    excerpt: "Le SYNDIC de Copropriété est une personne physique ou morale désignée par l'ensemble des copropriétaires d'un ensemble immobilier pour assurer l'administration, l'entretien et la conservation des parties communes de la copropriété. Désigné pour une durée d'un an renouvelable dans le cadre d'une Assemblée Générale, le Syndic de Copropriété a plusieurs missions strictement définies par la [...]",
    date: "30/10/2020",
    author: "userpro",
    tag: "Définition du mois",
    tagHref: "/articles/syndic-copropriete",
    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="mx-auto max-w-7xl px-6 py-8">
        ...
        <div className="mb-4 flex items-center gap-2 text-sm text-gray-500">
          ...
          <span className="text-gray-700">lexique immobilier</span>
        </div>
                ...
                <div className="p-6">
                  ...
                  <div className="flex flex-wrap items-center justify-between border-t border-gray-100 pt-4">
                    <div className="flex flex-wrap items-center gap-4 text-sm text-gray-400">
                      ...
                      <Link href={article.tagHref} className="text-primary hover:underline">
                        🔖 {article.tag}
                      </Link>
                    </div>
                    <Link
                  ...
                  <Link key={p.id} href={`/property/${p.id}`} className="flex gap-3 hover:opacity-80 transition-opacity">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500">
                        {p.chambres && `${p.chambres} Chambre${p.chambres > 1 ? "s" : ""}`}
                        {p.salles && ` • ${p.salles} Salle(s) de bain(s)`}
